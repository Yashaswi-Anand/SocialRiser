      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">Social Riser</h3>
                <p className="text-sm text-gray-400">Your Growth Our Success</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/influencer-marketing" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Influencer Marketing
                </Link>
              </li>
              <li>
                <Link href="/services/talent-management" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Talent Management
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Social Riser. All rights reserved.
          </p>
